                ...
                {skills.map((category) => (
                  <RadioGroup.Option
                    ...
                    className={({ checked }) =>
                      ...
                      flex-shrink-0 border border-white/20 backdrop-blur-sm hover:scale-105 transform transition-transform`
                    }
                  >
                    {category.title}
                  </RadioGroup.Option>
            ...
            >
              {category.skills.map((skill) => (
                <motion.div
                  ...
                  className="relative bg-gray-900/50 p-4 md:p-6 rounded-xl border border-white/10 hover:border-white/20 transition-all group backdrop-blur-sm shadow-xl"
                >
                  <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
                    <i
                      className={`devicon-${skill.icon}-plain text-2xl md:text-3xl text-white/90 min-w-[32px] md:min-w-[40px]`}
                    />
