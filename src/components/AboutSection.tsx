      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-sm md:text-base lg:text-xl text-gray-400 font-mono">
            Temesgen T. Gebremariam | Full-stack developer | Passionate about
        ...
        >
          ...
          <div className="p-4 md:p-8 bg-gray-900 rounded-lg border border-gray-800">
            <p className="text-sm md:text-base text-gray-300 mb-3 md:mb-4">
              I’m a developer who believes that technology should solve real
            ...
            <p className="text-sm md:text-base text-gray-300 mb-3 md:mb-4">
              Outside of coding, I’m a lifelong learner who enjoys diving into
              new technologies, exploring open-source projects, and sharing
              knowledge through writing and mentoring.
            </p>
            <p className="text-sm md:text-base text-gray-300">
              When I’m not at my desk, you’ll find me brewing coffee, listening
              to synthwave, or tinkering with side projects that combine my love
              for code and creativity.
            </p>
          </div>
        </motion.div>
              ...
              {[
                {
                  ...
                  icon: (
                    <Banknote className="w-4 h-4 md:w-5 md:h-5 text-emerald-400" />
                  ),
                },
                {
                  year: "2021",
                ...
                },
                {
                  ...
                  tech: ["Anaconda", "Machine Learning", "Data Analysis"],
                  description:
                    "Conducting research on data mining for brewery sales prediction while studying for an MBA in China.",
                  icon: (
                    <BarChart className="w-4 h-4 md:w-5 md:h-5 text-emerald-400" />
                  ),
                },
                {
                  year: "2025",
                  ...
                  icon: (
                    <Smartphone className="w-4 h-4 md:w-5 md:h-5 text-emerald-400" />
                  ),
                },
                {
                  year: "2025",
                ...
                >
                  <div className="flex items-center mb-2">
                    {item.icon}
                    <span className="font-mono text-sm md:text-base text-emerald-400 ml-2">
                      {item.year}
                    </span>
              ...
              {[
                {
                  ...
                  description:
                    "Design systems that can handle 10x traffic spikes without breaking a sweat.",
                  icon: "🚀",
                },
                {
                ...
                <div key={idx} className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-mono text-sm md:text-base text-emerald-400">
                      {item.principle}
                    </h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4">
              {[
                ...
                >
                  ...
                  <div className="font-mono text-sm md:text-base text-emerald-400">
                    {item.title}
                  </div>
              ...
              {[
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-mono text-sm md:text-base text-emerald-400 mb-1">
                        {item.title}
                      </h4>
                      <p className="text-sm md:text-base text-gray-300">
                        {item.description}
