export interface AboutData {
  ...
  export const aboutData: AboutData = {
    intro: "I’m a full-stack developer with a passion for building scalable, user-friendly applications. Over the years, I’ve transitioned from debugging CSS to architecting complex systems, always striving to learn and grow.",
    journey: [
      {
        year: "2018",
